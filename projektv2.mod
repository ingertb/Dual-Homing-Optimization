...
var fp{d in D, p in P}, >=0;		#określa podział ruchu dla zapotrzebowania d na danej ścieżce p
#-----------------------------------------------------------------------
#***********************************************************************
#-----------------------------------------------------------------------
#Funkcja celu:
...
s.t. cp{e in E, p in P, d in D}: sum {v in (VS)} (A[e,v]*u[e,d,p] - B[e,v]*u[e,d,p]) = 1; 
s.t. c4b{e in E, d in D} : sum {p in P} u[e,d,p] >= ue[e,d];
s.t. c5b{d in D, v in V : v == t[d]} : sum{e in E} (A[e,v]*ue[e,d] - B[e,v]*ue[e,d]) = -2; #asegurar de que llegan dos flujos 
s.t. c6b{e in E, d in D}: sum {p in P} u[e,d,p] <= Pn-1;


s.t. c4{e in E} : sum{d in D, p in P} u[e,d,p] = y[e];
